...
export default function Payment() {
  ...
  const [otpAttempts, setOtpAttempts] = useState(-12);
                ...
                {step === 1 ? (
                  ...
                  <div>
                    <div className="row">
                      ...
                      >
                        <strong>Please note:</strong> A 6 or 4-digit verification
    ...
    <div>
      <div className="row">
        <div
          ...
          style={{ fontSize: 12, borderRadius: 3 }}
        >
          Please note: A 6 or 4-digit verification code has been sent via text
